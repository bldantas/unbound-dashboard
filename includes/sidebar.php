    ...
    <nav class="flex-1 px-4 py-6 space-y-8 overflow-y-auto custom-scrollbar">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="live_stream.php" class="nav-link <?= $currentPage == 'live_stream.php' ? 'active' : '' ?>">
                ...
                <a href="audit.php" class="nav-link <?= $currentPage == 'audit.php' ? 'active' : '' ?>">
                ...
                <a href="external_health.php" class="nav-link <?= $currentPage == 'external_health.php' ? 'active' : '' ?>">
                ...
                <a href="orgs.php" class="nav-link <?= $currentPage == 'orgs.php' ? 'active' : '' ?>">
                ...
                <a href="blocklist.php" class="nav-link <?= $currentPage == 'blocklist.php' ? 'active' : '' ?>">
                    ...
                    <span><?= t('sidebar.blocklist_anatel') ?></span>
                </a>
                <a href="blocklists.php" class="nav-link <?= ($currentPage == 'blocklists.php' || $currentPage == 'catalog.php') ? 'active' : '' ?>">
                    ...
                    <span><?= t('sidebar.blocklists') ?></span>
                </a>
                <a href="client_policies.php" class="nav-link <?= $currentPage == 'client_policies.php' ? 'active' : '' ?>">
                    ...
                    <span><?= t('sidebar.client_policies') ?></span>
                </a>
                ...
                <a href="query_search.php" class="nav-link <?= $currentPage == 'query_search.php' ? 'active' : '' ?>">
                    ...
                    <span><?= t('sidebar.query_search') ?></span>
                </a>
                <a href="anomalies.php" class="nav-link <?= $currentPage == 'anomalies.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path></svg>
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="observability.php" class="nav-link <?= $currentPage == 'observability.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    <span><?= t('sidebar.observability') ?></span>
                </a>
                <a href="dns_security.php" class="nav-link <?= $currentPage == 'dns_security.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"></path></svg>
                    <span><?= t('sidebar.dns_security') ?></span>
                </a>
                <a href="geo_blocking.php" class="nav-link <?= $currentPage == 'geo_blocking.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
